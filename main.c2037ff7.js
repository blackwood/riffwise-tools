...
},{"fbjs/lib/invariant":12,"fbjs/lib/warning":14,"./lib/ReactPropTypesSecret":17}],9:[function(require,module,exports) {
...
},{"object-assign":11,"fbjs/lib/invariant":12,"fbjs/lib/emptyObject":13,"fbjs/lib/warning":14,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":16}],8:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.development.js":9}],21:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":30}],24:[function(require,module,exports) {
'use strict';
...
},{"./camelize":29}],20:[function(require,module,exports) {
/** @license React v16.4.0
...
},{"fbjs/lib/invariant":12,"react":8,"fbjs/lib/warning":14,"fbjs/lib/ExecutionEnvironment":21,"object-assign":11,"fbjs/lib/emptyFunction":15,"prop-types/checkPropTypes":16,"fbjs/lib/getActiveElement":22,"fbjs/lib/shallowEqual":23,"fbjs/lib/containsNode":24,"fbjs/lib/emptyObject":13,"fbjs/lib/hyphenateStyleName":25,"fbjs/lib/camelizeStyleName":26}],19:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":20}],34:[function(require,module,exports) {
"use strict";
...
var equalWeight = function equalWeight(tuple) {
...
function generateExercise() {
  ...
  var chords = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var scales = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];

  var exercise = equalWeight([equalWeight(chords) + " chord", equalWeight(scales) + " scale"]);
  return getNested(roots) + exercise;
}

var ExerciseGenerator = function (_React$Component) {
  _inherits(ExerciseGenerator, _React$Component);

  function ExerciseGenerator() {
    _classCallCheck(this, ExerciseGenerator);

    var _this = _possibleConstructorReturn(this, (ExerciseGenerator.__proto__ || Object.getPrototypeOf(ExerciseGenerator)).call(this));
  ...
  _createClass(ExerciseGenerator, [{
    key: "getInitialState",
    ...
    value: function handleSubmit(e) {
      e.preventDefault();
      this.setState({ exercise: generateExercise(_constants.roots, _constants.chords, _constants.scales) });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "div",
            { className: "exercisePrompt standout" },
            exercise
          )
        ),
        _react2.default.createElement(
...
},{"react":8,"react-dom":19,"./constants":34}],36:[function(require,module,exports) {
...
//# sourceMappingURL=/main.c2037ff7.map